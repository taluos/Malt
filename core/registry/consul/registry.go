...
var (
	_ registry.Registrar = (*Registry)(nil) // Register()、Deregister()
	_ registry.Discovery = (*Registry)(nil) // GetService()、ListServices()、Watch()
)
...
func (r *Registry) Watch(ctx context.Context, name string) (registry.Watcher, error) {
	...
	r.lock.Lock()
	// get service set if registered, if not, create new service set
