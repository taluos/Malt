...
func (s *ginServer) Group(relativePath string, handlers ...interface{}) RouteGroup {
...
// Use 实现Server.Use
func (s *ginServer) Use(middleware ...interface{}) Server {
...
func (s *ginServer) Handle(httpMethod, relativePath string, handlers ...interface{}) Server {
	ginHandlers := convertToGinHandlers(handlers...)
...
func (g *ginRouteGroup) Group(relativePath string, handlers ...interface{}) RouteGroup {
	ginHandlers := convertToGinHandlers(handlers...)
...
func (g *ginRouteGroup) Use(middleware ...interface{}) RouteGroup {
	ginMiddleware := convertToGinHandlers(middleware...)
...
func (g *ginRouteGroup) Handle(httpMethod, relativePath string, handlers ...interface{}) RouteGroup {
	ginHandlers := convertToGinHandlers(handlers...)
...
func (g *ginRouteGroup) GET(relativePath string, handlers ...interface{}) RouteGroup {
	ginHandlers := convertToGinHandlers(handlers...)
...
func (g *ginRouteGroup) POST(relativePath string, handlers ...interface{}) RouteGroup {
	ginHandlers := convertToGinHandlers(handlers...)
...
func (g *ginRouteGroup) PUT(relativePath string, handlers ...interface{}) RouteGroup {
	ginHandlers := convertToGinHandlers(handlers...)
...
func (g *ginRouteGroup) DELETE(relativePath string, handlers ...interface{}) RouteGroup {
	ginHandlers := convertToGinHandlers(handlers...)
...
func (g *ginRouteGroup) PATCH(relativePath string, handlers ...interface{}) RouteGroup {
	ginHandlers := convertToGinHandlers(handlers...)
...
func (g *ginRouteGroup) HEAD(relativePath string, handlers ...interface{}) RouteGroup {
	ginHandlers := convertToGinHandlers(handlers...)
...
func (g *ginRouteGroup) OPTIONS(relativePath string, handlers ...interface{}) RouteGroup {
	ginHandlers := convertToGinHandlers(handlers...)
...
// 辅助函数：转换通用处理器为Gin处理器
func convertToGinHandlers(handlers ...interface{}) []gin.HandlerFunc {
...
// 辅助函数：转换通用选项为Gin选项
func convertOptions(opts ...ServerOptions) []httpserver.ServerOptions {
